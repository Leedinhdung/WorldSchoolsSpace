...
@section('content')
    ...
    <form action="{{ route('admin.banner.update', $getBannerById->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8 mb-3">
                                ...
                                <input type="text" value="{{ $getBannerById->title }}" name="title"
                            ...
                            <div class="col-4 mb-3">
                                ...
                                <input type="text" name="url" value="{{ $getBannerById->url }}" class="form-control"
                        ...
                        <div>
                            ...
                            <label for="">Ảnh</label>
                            <div class="text-center p-3 border border-dashed mb-2">
                                <img src="{{ Storage::url($getBannerById->image) }}" width="300px" class="rounded"
                                    alt="">
                            </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <label class="switch">
                            <input {{ $getBannerById->is_active == 1 ? 'checked' : '' }} name="is_active" id="is_active"
