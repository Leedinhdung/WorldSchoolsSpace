...
@section('content')
    ...
    <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" id="createproduct-form" autocomplete="off"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="excerpt" id="excerpt" cols="30" rows="4">{{ $post->excerpt }}</textarea>
                            <small class="help-block form-text text-danger">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <label class="switch">
                            <input {{ $post->is_active == 1 ? 'checked' : '' }} name="is_active" id="is_active"
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div id="" class="border rounded p-2">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Đổi ảnh đại diện mới cho bài viết của bạn</p>
...
@section('script-libs')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let tagsArray = hiddenInput.value ? hiddenInput.value.split(',') :
        []; // Khởi tạo mảng tags từ các tag cũ
