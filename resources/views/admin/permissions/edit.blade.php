...
@section('content')
    ...
    <form action="{{ route('admin.permission.update', $permissionID->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $permissionID->name }}">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" class="form-control" value="{{ $permissionID->slug }}"
