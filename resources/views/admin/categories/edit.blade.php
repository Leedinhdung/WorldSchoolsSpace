...
@section('content')
    ...
    <form action="{{ route('admin.categories.update', $getCategoryById->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ $getCategoryById->name }}" name="name" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" value="{{ $getCategoryById->slug }}" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" id="description" cols="30" rows="4">{{ $getCategoryById->description }}</textarea>
                            <small class="help-block form-text text-danger">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <label class="switch">
                            <input {{ $getCategoryById->is_active == 1 ? 'checked' : '' }} name="is_active" id="is_active"
